  ...
  <div class="setup-container">
    <div class="window-frame">
      <div class="title-bar">
        ...
        />
        <div class="title">Windows Setup</div>
      ...
      <div class="content">
        ...
        <button class="next-btn" style="margin-top:100px" @click="router.push('/setup/step4')">
          <u>I</u>nstall now
        </button>

        <div class="footer">
          <div class="copyright">
            <div style="font-size:18px;padding-bottom: 10px"><u>R</u>epair your computer</div>
