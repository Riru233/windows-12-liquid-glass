<template>
  <div class="toolbar">
    ...
    <liquidglass
      ...
      :blur="10"
      position="relative"
      :layerStyle="`display:flex;flex-direction:row;align-items:center;padding-left:10px;`"
      layerClass="glass-fog"
      class="search "
    >
      <div>
        <!-- copilot -->
      ...
      <div style="margin-left: 10px">
        <span>Ask Copilot for settings</span>
      </div>
    </liquidglass>
  </div>
</template>
