<template>
  ...
  >
    <!-- 第一层：询问Copilot -->
    <div
      style="width: calc(100% - 30px); margin: 15px 0 15px 15px; display: flex"
    >
      <!-- 电池状态 -->
    ...
    <div style="width: calc(100% - 30px); margin: 15px 0 15px 15px; display: flex;gap: 5px;">
      <TopButton :width="60" :height="36" :radius="18" style="background-color: #1a76c666;border-radius: 16px;filter: none;">推荐</TopButton>
...
.colorful svg {
  filter: drop-shadow(0px 0px 2px #ffffff) drop-shadow(0px 0px 4px #ffffff);
}
