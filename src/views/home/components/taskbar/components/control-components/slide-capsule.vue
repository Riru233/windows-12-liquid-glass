<template>
  ...
  >
    ...
    >
      <div
        :style="`width: 100%;height:100%;color:${props.vol<8 ? '#333':'#fff'};background: linear-gradient(to right, #0023f555 0%, #0023f555 ${props.vol}%,#fff0 ${props.vol}%);justify-content:center;display:flex;align-items:center;`"
      >
