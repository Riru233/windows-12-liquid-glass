...
.selected {
  display: flex;
  backdrop-filter: url(#liquid-selected);
  width: 200px;
  align-items: center;
  justify-content: center;
  border-top: #fff6 1px solid;
  border-bottom: #fff6 1px solid;
