<template>
  ...
  >
    ...
    <div
      ...
      :style="
        props.active
          ? `border-radius:${config_layer2.radius}px;background:linear-gradient(to bottom, #23aaf233);backdrop-filter: brightness(1.2)`
          : `background:transparent;border-radius:${config_layer2.radius}px;`
      "
    ></div>
