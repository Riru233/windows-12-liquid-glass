<template>
  <liquidWin title="About Windows" :width="400" :height="400" @updatePos="updatePos"
    ...
    <div style="display: flex; flex-direction: column; flex: 1; justify-content: center;">
      <div id="actionbar"
        style="height: 40px; text-align: center; width: 100%; margin: 10px 0; color: #fff; align-items: center; font-size: 32px; display: flex; flex-direction: row; justify-content: center; gap: 8px;">
        <svg class="icon" viewBox="0 0 1024 1024" width="48px" height="48px">
          <defs>
            <linearGradient id="lg-about" x1="0%" y1="0%" x2="100%" y2="100%">
              ...
              <stop offset="100%" stop-color="#fff6" />
            </linearGradient>
          </defs>
          <path
      ...
      <div style="display: flex; flex-direction: row">
        <button
          style="margin: 10px; height: 32px; font-size: 14px; border: none; border-radius: 20px; border-bottom: #ccca 1px solid; background: linear-gradient(to bottom, #fff6, #8886); padding: 0 10px; color: #fffc; box-shadow: #fff -0.5px -0.5px 0.5px, #fff 0.5px 0.5px 0.5px;">More
          Information</button>
        <div style="flex-grow: 1"></div>
        <button
          style="margin: 10px; height: 32px; font-size: 14px; border: none; border-radius: 20px; border-bottom: #fffa 1px solid; background-color: #24acf2; color: #fffc; padding: 0 10px; box-shadow: #fff -0.5px -0.5px 0.5px, #fff 0.5px 0.5px 0.5px;">Confirm</button>
      </div>
    </div>
  </liquidWin>
</template>
