    ...
    >
      ...
      >
        ...
        <svg
          ...
          viewBox="-50.25 -74.228 435.5 445.368"
        >
          <radialGradient
            r="33.43"
          ...
          <radialGradient
            ...
            r="30.869"
            gradientUnits="userSpaceOnUse"
            gradientTransform="matrix(.9732 0 0 -.9795 -286.102 -136.415)"
            cy="-191.691"
            cx="256.776"
            id="k"
          />
          ...
          <path
            fill="url(#p)"
            d="M-69.99 67.572c.041.005.113-.034.113-.034.09.063.162.104.162.104s-.142.033-.275-.07z"
            transform="translate(350.115 -85.539) scale(4.96547)"
          />
          <path
            fill="#152469"
            d="M118.188 255.41s.407.393.893.274l-1.862 1.112c-.596.268-1.226-.164-1.226-.164z"
          />
          <path
            fill="url(#q)"
            d="M-69.869 67.541s-.075.042-.116.036l-.414-.318-.007-.008a.39.39 0 00.151.004z"
            transform="translate(350.115 -85.539) scale(4.96547)"
          />
          <path
            fill="#152469"
          ...
          <path
            opacity=".66"
            fill="#063367"
            d="M.049 246.974l30.329-106.142.363.09L.41 246.805z"
          />
          <path
            opacity=".42"
            fill="url(#u)"
          ...
          <path
            fill="url(#D)"
            d="M-18.02 72.447c.022-.118-.111-.228-.111-.228l5.959-20.766s.096.085.125.152z"
            transform="translate(350.115 -85.539) scale(4.96547)"
          />
          <path
            fill="url(#E)"
          ...
          <path
            opacity=".66"
            fill="#b37e00"
            d="M260.155 273.167l-.129.258-2.587-2.234 29.758-103.168 2.498 2.006z"
          />
          <path
            fill="url(#H)"
          ...
          <path
            fill="#d9a200"
            d="M131.306 264.885v-.249l30.399-105.248 2.08-1.41-30.13 105.04z"
          />
          <path
            opacity=".66"
            fill="url(#I)"
          ...
          <path
            fill="url(#O)"
            d="M-43.076 70.3c-.179-.105-.383-.184-.556-.115l6.106-21.143a.58.58 0 01.559.027z"
            transform="translate(350.115 -85.539) scale(4.96547)"
          />
          <path
            opacity=".33"
          ...
          <path
            fill="url(#R)"
            d="M-18.944 72.16s-.232-.141-.188-.462a.54.54 0 01.513.115s-.051.229-.325.347z"
            transform="translate(350.115 -85.539) scale(4.96547)"
          />
          <path
            fill="url(#S)"
          ...
          <path
            fill="#bc1b00"
            d="M154.52 129.362s.402.283.874.184l-1.927.869c-.526.139-1.152-.18-1.152-.18z"
          />
          <path
            fill="#b81a00"
          ...
          <path
            fill="#e32e00"
            d="M66.591 14.585l.283.084-30.681 106.505c-.07-.05-.378-.12-.378-.12z"
          />
          <path
            opacity=".66"
            fill="url(#U)"
          ...
          <path
            opacity=".5"
            fill="url(#W)"
            d="M-33.668 22.178l.007.008.001-.014z"
            transform="translate(350.115 -85.539) scale(4.96547)"
          />
          <path
            opacity=".5"
          ...
          <path
            fill="url(#aa)"
            d="M-57.04 20.181l-.058-.015a.183.183 0 01.112-.131l.009-.002c0-.001-.03.044-.063.148z"
            transform="translate(350.115 -85.539) scale(4.96547)"
          />
          <path
            opacity=".66"
          ...
          <path
            fill="#8cac42"
            d="M167.251 140.296v-.238l30.558-105.76 2.24-1.594-30.454 105.725z"
          />
          <path
            fill="url(#ae)"
            d="M-35.892 45.348c-.188-.109-.329-.325-.499-.257l6.146-21.267a.53.53 0 01.557.053z"
            transform="translate(350.115 -85.539) scale(4.96547)"
          />
          <path
            fill="#5f821c"
          ...
          <path
            opacity=".81"
            fill="url(#ag)"
            d="M-10.985 47.166l-.473-.411 6.21-21.385.507.402z"
            transform="translate(350.115 -85.539) scale(4.96547)"
          />
          <path
            fill="#476e32"
            d="M296.175 149.442c.074-.615-.556-1.102-.556-1.102l30.91-106.008s.501.437.626.745z"
          />
          <path
            fill="#1d3419"
          ...
          <path
            fill="url(#ah)"
            d="M-11.75 47.123s-.237-.214-.197-.526a.58.58 0 01.536.117s-.065.291-.339.409z"
            transform="translate(350.115 -85.539) scale(4.96547)"
          />
          <path
            fill="url(#ai)"
            d="M-11.411 46.714l.444.397s-.067.246-.337.364l-.465-.395a.658.658 0 00.358-.366z"
            transform="translate(350.115 -85.539) scale(4.96547)"
          />
          <path
            fill="url(#aj)"
          ...
          <path
            fill="url(#ak)"
            d="M-36.827 45.433l.453-.357a.5.5 0 00.267.485l-.458.355a.505.505 0 01-.262-.483z"
            transform="translate(350.115 -85.539) scale(4.96547)"
          />
          <path
            fill="url(#al)"
