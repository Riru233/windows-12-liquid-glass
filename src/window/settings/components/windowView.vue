<template>
  <div id="contentbar" ref="contentbar">
    ...
    <div :style="`position:fixed;height:98px;width:948px;z-index:2;margin-top:-40px;`">
        ...
        <div>
          <div style="
            ...
            <div style="
                ...
                color: #555;
              ">
              <div style="margin-left: 10px; padding-top: 10px; line-height: 0.8em">
                ————
              </div>
        ...
        <div style="
          ...
          <div class="icons">
            <svg class="icon" style="
                ...
                fill: currentColor;
                overflow: hidden;
              " viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="10418">
              <path
            ...
            <div class="icons">
              <svg class="icon" style="
                ...
                <path
                  ...
                  fill="currentColor" p-id="3963"></path>
              </svg>
            </div>
            <div style="
                display: flex;
