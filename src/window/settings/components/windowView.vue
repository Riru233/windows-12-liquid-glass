  ...
  <div id="contentbar" ref="contentbar">
    ...
    >
      ...
      <div style="display: flex; flex-direction: row; gap: 10px">
        ...
        >
          <div style="font-size: 14px; font-weight: bold">微软示例用户</div>
      ...
      >
        ...
        <div style="font-size: 15px">主页</div>
      </div>
      <!-- 系统 -->
      ...
      >
        ...
        <div style="font-size: 15px">系统</div>
      </div>
      <!-- 蓝牙和其他设备 -->
      <div
        style="
      ...
      >
        ...
        <div style="font-size: 15px">蓝牙和设备</div>
      </div>
      <!-- 网络和因特网 -->
      <div
        style="
      ...
      >
        ...
        <div style="font-size: 15px">以太网与 Wi-Fi</div>
      </div>
      <!-- 个性化 -->
      <div
        style="
      ...
      >
        ...
        <div style="font-size: 15px">个性化</div>
      </div>
      <!-- 应用 -->
      <div
        style="
      ...
      >
        ...
        <div style="font-size: 15px">账户</div>
      </div>
      <!-- 时间和语言 -->
      <div
        style="
      ...
      >
        ...
        <div style="font-size: 15px">时间与区域</div>
      </div>
      <!-- 游戏 -->
      <div
        style="
      ...
      >
        ...
        <div style="font-size: 15px">游戏助手</div>
      </div>
      <!-- 辅助功能 -->
      <div
        style="
      ...
      >
        ...
        <div style="font-size: 15px">轻松使用与无障碍</div>
      </div>
      <!-- 安全和隐私 -->
      <div
        style="
      ...
      >
        ...
        <div style="font-size: 15px">隐私与安全</div>
      </div>
      <!-- Windows Update -->
      <div
        style="
      ...
      >
        ...
        <div style="font-size: 15px">Windows 更新</div>
      </div>
    </liquid_glass>
    <div class="content">
      <!-- 标题拟态玻璃 -->
      <liquid_glass
        style="margin: 10px 20px; color: #000; background: #fff6"
        layerStyle="margin:10px 20px;display:flex;flex-direction:row;gap:0.4em"
        width="150"
        height="40"
        radius="20"
        :displacementScale="250"
      ...
      >
        ...
        >
          ...
          <div style="height: 60px" class="flex-lr">
            ...
            <div
              ...
              "
            >
              <div style="color: #000; font-size: 14px">选择材质外观</div>
              <div style="color: #555; font-size: 12px">
                更改 Windows 和应用的材质效果
              </div>
            </div>
            <div class="select-box">
              <div style="color: #000; font-size: 14px">混合</div>
              <div style="flex-grow: 1"></div>
              <svg
                class="icon"
                width="12"
          ...
          <div class="flex-lr" style="height: 60px; border-top: #ccc 1px solid">
            ...
            <div
              ...
              "
            >
              <div style="color: #000; font-size: 14px">组件材质</div>
              <div style="color: #555; font-size: 12px">
                应用于开始、控制中心等组件的材质
              </div>
            </div>
          ...
          <div class="flex-lr" style="height: 60px; border-top: #ccc 1px solid">
            ...
            <div
              ...
              "
            >
              <div style="color: #000; font-size: 14px">文字白雾效果</div>
              <div style="color: #555; font-size: 12px">
                通透玻璃条件下增强可读性
              </div>
            </div>
            <div class="select-box">
              <div style="color: #000; font-size: 14px">开启</div>
              <div style="flex-grow: 1"></div>
              <svg
                class="icon"
                width="12"
          ...
          <div class="flex-lr" style="height: 60px">
            ...
            <div
              ...
              "
            >
              <div style="color: #000; font-size: 14px">自定义颜色浓度</div>
              <div style="color: #555; font-size: 12px">
                根据实际情况自定义调节颜色浓度
              </div>
            </div>
        ...
        >
          ...
          <div
            ...
            "
          >
            <div style="color: #000; font-size: 14px">主题色</div>
          </div>
          <div class="select-box">
            <div style="color: #000; font-size: 14px">跟随壁纸</div>
            <div style="flex-grow: 1"></div>
            <svg
              class="icon"
              width="12"
        ...
        >
          ...
          <div
            ...
            "
          >
            <div style="color: #000; font-size: 14px">高对比度主题</div>
            <div style="color: #555; font-size: 12px">
              适用于弱视和强光敏感的彩色主题
            </div>
          </div>
        ...
        >
          ...
          <div
            ...
            @click="showHelp"
          >
            <div style="color: #000; font-size: 14px">外观帮助</div>
          </div>
          <div>
            <svg
              class="icon"
