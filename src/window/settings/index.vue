<template>
  <LiquidWin :width="950" :height="650" :displacementScale="78" v-model:top="top" v-model:left="left"
    @updatePos="updatePos" :active="props.active" v-slot="{ startDrag }">
      ...
      <div class="titlebar" @mousedown="startDrag">
        ...
        <div style="
          ...
          <div style="padding: 0 16px">
            <!-- copilot -->
            <svg class="icon windowBtnStd" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"
              ...
              <defs>
                ...
                <linearGradient id="zqv70o08-paint5_linear_262034_2117" x1="28.6736" y1="8.30469" x2="28.6627"
                  y2="13.617" gradientUnits="userSpaceOnUse">
...
/* 移除原有的 #glass-window 相关样式，因为 LiquidWin 内部已处理 */
</style>