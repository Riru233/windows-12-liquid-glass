<template>
  <div class="toolbar">
    <div class="addressSearch">
      ...
      <!-- 地址栏 -->
      <LiquidGlass class="fix-glass" :width="453" :height="26" :radius="15" :displacementScale="78" :precise="1"
        :drag="false" :config_layer2="{
          radius: 15,
          gamma: 1,
          deadzone: 0.05,
          edge: 12,
      ...
      <!-- 搜索栏 -->
      <LiquidGlass class="fix-glass" :width="236" :height="26" :radius="15" :displacementScale="78" :precise="1"
        :drag="false" :config_layer2="{
          radius: 15,
          gamma: 1,
          deadzone: 0.05,
        ...
        <div class="search">
          <div style="
            filter: drop-shadow(0 0 2px #ffffff) drop-shadow(0 0 4px #ffffff);margin-top:3px;
          ">
            <!-- copilot -->

            <img src="/icons/copilot.png" alt="" width="14px" style="margin: 0;padding: 0;">
          </div>
          <div style="
